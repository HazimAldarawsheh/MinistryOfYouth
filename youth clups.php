...
<body>
    ...
    <header>
        ...
        <nav>
            <div class="topnav">
                <div class="tobnav-left">
                    <a href=""><img src="images/youth_ministry_logo-removebg-preview.png" width="138px" height="98px"
                            alt=""></a>
                </div>
                ...
                <ul class="topnav">
                    ...
                    <li class="top-right">
                        <a href="About.html">عن وزارة الشباب</a>
                    </li>

                    
                    <li class="top-right cool-linkN">
                        <a href="sportCity and YouthClubs.html" class="active"> مدننا الرياضية و المراكز الشبابية</a>
                    </li>
                    ...
                    <li class="top-right">
                        <a href="Announcements.html">الاعلانات</a>
                    </li>

                    <li class="top-right">
                        <a href="National youth stratigy.html">الاستراتيجية الوطنيه للشباب</a>
                    </li>
    ...
    <div id="container">
        ...
        <div class="head-txt">
            <h1>المراكز الشبابية</h1>
        </div>

        <div class="jordan-map shadow-5 borRad15" >
            <svg version="1.2" viewbox="0 0 1000 1127" xmlns="http://www.w3.org/2000/svg">
                <a xlink:title="Aqaba" href="youth clups.php?region_id=11">
                    <path
                        ...
                        id="JOR849" name="Aqaba" href="youth clups.php?region_id=11">
                    </path>
                </a>

                <a xlink:title="Mafraq" href="youth clups.php?region_id=5">
                    <path
                        ...
                        id="JOR850" name="Mafraq">
                    </path>
                </a>
                <a xlink:title="Amman" href="youth clups.php?region_id=2">
                    <path
                        ...
                        id="JOR851" name="Amman">
                    </path>
                </a>
                <a xlink:title="Tafilah" href="youth clups.php?region_id=12">
                    <path
                        ...
                        id="JOR852" name="Tafilah">
                    </path>
                </a>
                <a xlink:title="Ma`an" href="youth clups.php?region_id=9">
                    <path
                        ...
                        id="JOR853" name="Ma`an">
                    </path>
                </a>
                <a xlink:title="Irbid" href="youth clups.php?region_id=1">
                    <path
                        ...
                        id="JOR854" name="Irbid">
                    </path>
                </a>
                <a xlink:title="Ajlun" href="youth clups.php?region_id=3">
                    <path
                        ...
                        id="JOR855" name="Ajlun">
                    </path>
                </a>
                <a xlink:title="Jarash" href="youth clups.php?region_id=4">
                    <path
                        ...
                        id="JOR856" name="Jarash">
                    </path>
                </a>
                <a xlink:title="Balqa" href="youth clups.php?region_id=8">
                    <path
                        ...
                        id="JOR857" name="Balqa">
                    </path>
                </a>
                <a xlink:title="Madaba" href="youth clups.php?region_id=6">
                    <path
                        ...
                        id="JOR858" name="Madaba">
                    </path>
                </a>
                <a xlink:title="Karak" href="youth clups.php?region_id=10">
                    <path
                        ...
                        id="JOR859" name="Karak">
                    </path>
                </a>
                <a xlink:title="Zarqa" href="youth clups.php?region_id=7">
                    <path
                        ...
                        id="JOR860" name="Zarqa">
                    </path>
                </a>
                <circle cx="150.9" cy="286.2" id="0">
                </circle>
                <circle cx="258.7" cy="339.7" id="1">
                </circle>
                <circle cx="268.7" cy="548" id="2">
                </circle>
            </svg>
        </div>
        ...
        <div>
            ...
            <ul class="responsive-table">
                <li class="table-header">
                    <div class="col col-3">رقم الهاتف</div>
                    <div class="col col-2">اسم النادي</div>
                    <div class="col col-1">الرقم</div>
                ...
                <?php
                  ...
                  $counter=1;
                  $result=$mysqli->query("SELECT * FROM moyouth.youthclubs where region_id = '$region';");     
                  if(!$result){
                  echo "no data";
          }
        else{
        ...
        while($row=$result->fetch_assoc()){
            echo "<li class='table-row'>";
                    echo "<div class='col col-3' data-label='رقم الهاتف'>$row[phone_number]</div>";
                    echo "<div class='col col-2' data-label='اسم النادي'>$row[club_name]</div>";
                    echo "<div class='col col-1' data-label='الرقم'>$counter</div>";
            echo "</li>";
            $counter++;
		  }  
    }
    ...
    <footer>
        <div class="footer-boxes">
            <div class="col-md-4 socials f-mar">
                <ul>
                    <li class="row">
                        <a href="https://twitter.com/MoY_JO" target="_blank">
                            <img src="social media logos/iconfinder_2018_social_media_popular_app_logo_twitter_3228543.svg"
                                alt="">
                            <span>/MOY_Jo</span>
                        </a>
                    </li>
                    ...
                    <li class="row">
                        <a href="https://www.facebook.com/MoYJordan?_rdc=1&_rdr" target="_blank">
                            <img src="social media logos/iconfinder_2018_social_media_popular_app_logo_facebook_3228552.svg"
                                alt="">
                            <span>/MoyJordan</span>
                        </a>
                    </li>
                    ...
                    <li class="row">
                        <a href="https://www.instagram.com/moy_jo" target="_blank"><img
                                src="social media logos/iconfinder_2018_social_media_popular_app_logo_instagram_3228551.svg"
                                alt="">
                            <span>/MOY_Jo</span>
                        </a>
                    </li>
                    ...
                    <li class="row">
                        <a href="https://www.youtube.com/channel/UCI7EQEFVNTuXzo1nk2Ey-ng" target="_blank"><img
                                src="social media logos/iconfinder_2018_social_media_popular_app_logo_youtube_3228540.svg"
                                alt="">
                            <span>/MOY Jordan</span>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-4 info f-mar">
                <div class="cu" style="padding-bottom: 15px;">
                    <span>اتصل بنا</span>
                    <br>
                ...
                <div class="ci">
                    <span class="sp-1">+هاتف : 96206560471</span>

                    <br> <span class="sp-1">فاكس : 5604717</span><br>
                    <span class="sp-1">صندوق البريد : 1794 عمان الاردن</span><br>
                    <span class="sp-1">
                        moy.web@gov.jo
                        : البريد الالكتروني
                    </span>
        ...
        <div class="d-footer"><span>All Rights Reserved</span></div>
    </footer>
